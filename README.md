# Emmanuel Nyandu Kagarabi — Academic Portfolio

Personal academic portfolio website built with HTML, CSS, and Bootstrap 5.
Live at [emmanuelnyandukagarabi.github.io](https://emmanuelnyandukagarabi.github.io)
...
│   ├── research-interests.html # Research areas & linked repositories
│   ├── projects.html           # Theses, posters, and teaching resources
│   └── contact.html            # Contact information
├── assets/
│   └── css/
│       └── style.css           # Custom styles
├── static/                     # Profile image and CV PDF
├── theses/                     # Downloadable thesis PDFs
├── posters/                    # Conference poster PDFs
├── courses/                    # Teaching material PDFs
├── robots.txt
└── README.md
```
...
- LinkedIn: [emmanuel-nyandu-kagarabi](https://www.linkedin.com/in/emmanuel-nyandu-kagarabi-5410a4304/)
- GitHub: [emmanuelnyandukagarabi](https://github.com/emmanuelnyandukagarabi)
